  ...
  <div class="grid grid-cols-7 gap-y-0.5 my-1">
    ...
    >
      <div
        ...
        :key="keyDate"
        class="relative [&:has(>span.start-active)]:rounded-l-custom [&:has(>span.start-active)]:bg-primary/5 [&:has(>button.end-active)]:bg-primary/5 [&:has(>button.end-active)]:rounded-r-custom dark:[&:has(>span.start-active)]:bg-dark-primary/10 dark:[&:has(>button.end-active)]:bg-dark-primary/10"
      ...
      >
        ...
        >
          <span
            ...
            class="absolute bg-primary/5 bg-opacity-60 dark:bg-dark-primary/10"
            :class="betweenRangeClasses(date)"
          ></span>
        </transition>
        <button
          type="button"
          class="vtd-datepicker-date relative w-[2.7rem] h-[2.7rem] lg:w-10 lg:h-10 flex justify-center items-center text-xs 2xl:text-sm z-10"
